...
def first(u0,deltat,steps,rk4steps,k,expconsts,epsilon):
...
def second(u0,deltat,steps,rk4steps,k,expconsts,epsilon):
...
def sixth(u0,deltat,steps,rk4steps,k,expconsts,epsilon):
